...
/**
 * @brief Soma todos os elementos de um vetor de inteiros de 16 bits
 *
 * @param dados Vetor de inteiros a ser somado
 * @return A soma de todos os elementos do vetor
 */
...
/**
 * @brief Multiplica cada elemento de um vetor de inteiros de 16 bits por um fator
 *
 * @param dados Vetor de inteiros a ser multiplicado
 * @param fator O valor pelo qual cada elemento do vetor será multiplicado
 * @return Um novo vetor contendo os resultados da multiplicação
 */
