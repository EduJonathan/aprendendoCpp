...
- As expressões regulares (Regex) são poderosas ferramentas usadas
  para representar padrões em strings. Elas permitem que você faça
  validação, substituição e manipulação de dados de forma eficiente.
...
- **Asterisco (\_):** Zero ou mais ocorrências.
  - Exemplo: a\_ casa com "", "a", "aa", "aaa", etc.
...
de seus fundamentos, elas se tornam uma ferramentas extremamente poderosas.
